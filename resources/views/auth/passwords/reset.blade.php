                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" placeholder="Địa chỉ email.." class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
